...
namespace LightBox
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        {
            e.Handled = !hexEntered;
        }

        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            String hexStr = textBox1.Text;
            int strLen = hexStr.Length;
            int bytesCount = strLen >> 1;

            if (strLen == bytesCount*2) {
                // calculate CRC
                for (int i = 0; i < bytesCount; i++) {
                    data[i] = byte.Parse(hexStr.Substring(i * 2, 2), System.Globalization.NumberStyles.HexNumber);
                    System.Console.Write(data[i]);
                }
                textBox2.Text = strLen > 0 ? Convert.ToString(crc8(data, bytesCount), 16) : "";
            }
        }
    }
}
